	...
	remover_id:
		...
		la 	t1, loc_id	# t1 = endereÁo base da locomotiva (nosso "anterior")
		lw	t2, 0(t1)	# t2 = ID da locomotiva
		beq	t3, t2, erro_remover_loc
		
		lw	t0, 8(t1)	# t0 = endereÁo do primeiro vagao dinamico (nosso "atual")
	...
	faz_remocao:
		...
		lw	t2, 8(t0)	# t2 = endereÁo que o vagao removido estava apontando
